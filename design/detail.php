...
<div id="content">
	...
	<div class="container">
		<div class="two-thirds column">
		 ...
		 <div class="paper-record" id="pane"> 
...
<br /><span class="text-label">PubMed ID:</span> <a href="">22 329 620</a></p>
       ...
       <ul id="tabs" class="tabs">
		...
		<div id="ratings" class="content">
        	...
        	<td width="25%"><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_off.jpg" border="0" class="rated" /></td>
        	<td width="25%"><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /></td>
        	<td width="25%"><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_on.jpg" border="0" class="rated" /><img src="_img/rating_off.jpg" border="0" class="rated" /><img src="_img/rating_off.jpg" border="0" class="rated" /></td>
        	</tr>
        	</table>
        	...
        	<br /><br /><a href="#dialog" name="modal"><input type="button" value="Add your rating" /></a></p>
		</div>
		...
		<div id="citations" class="content">
			<h4>Cited Works</h4>
             <hr class="tab-rule" />
                ...
                <h6><a href="http://www.clientwebstage.com/msrc/citagora/detail.php">Suicide risk and precipitating circumstances among young, middle-aged, and older male veterans</a></h6> 
                <p class="authors">Jones, D., Smith, A.</p> 
                <h6><a href="http://www.clientwebstage.com/msrc/citagora/detail.php">Inaugural symposium examines military-civilian medical ties</a></h6> 
                <p class="authors">Jones, D., Smith, A.</p> 
		...
		<div id="export" class="content">
			<h4>Export this record</h4>
             ...
             <input type="checkbox" />Zotero <input type="checkbox" />BibTex <input type="checkbox" />Etc
             <br /><br /><input type="button" value="Export" />
